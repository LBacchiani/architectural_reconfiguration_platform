...
ARG5 is optional. It is a flag '--optimal' and its presence enable optimal placement within existing nodes. If this flag is enabled, Pulumi deployment will be slower.
```
